 ...
 *
 */
package net.mcreator.cumdimension;
...
@Mod("cum_dimension")
public class CumDimensionMod {
	public static final Logger LOGGER = LogManager.getLogger(CumDimensionMod.class);
	public static final String MODID = "cum_dimension";
