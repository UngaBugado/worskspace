...
import net.mcreator.cumdimension.item.LeCumDimensionItem;
...
public class CumDimensionModItems {
	...
	public static final RegistryObject<Item> LE_CUM_DIMENSION = REGISTRY.register("le_cum_dimension", () -> new LeCumDimensionItem());
